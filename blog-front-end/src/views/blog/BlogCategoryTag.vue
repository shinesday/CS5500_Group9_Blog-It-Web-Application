    ...
    methods: {
      ...
      getCategoryDetail(id) {
        ...
        getCategoryDetail(id).then(data => {
          ...
          if (error !== 'error') {
            that.$message({type: 'error', message: 'articles category loading fail....', showClose: true})
          }
        })
      },
      getTagDetail(id) {
        ...
        getTagDetail(id).then(data => {
          ...
          if (error !== 'error') {
            that.$message({type: 'error', message: 'Tag loading fail', showClose: true})
          }
        })
      },
      getArticlesByCategory(id) {
        ...
        getArticlesByCategory(id).then(data => {
          ...
          if (error !== 'error') {
            that.$message({type: 'error', message: 'articles loading fail', showClose: true})
          }
        })
      },
      getArticlesByTag(id) {
