    ...
    <el-row class="me-header">
      ...
      <el-col v-if="!simple" :span="16">
        <el-menu :router=true menu-trigger="click" active-text-color="#5FB878" :default-active="activeIndex"
          ...
          <el-menu-item index="/category/all">Article Category</el-menu-item>
          <el-menu-item index="/tag/all">Tags</el-menu-item>
          <el-menu-item index="/archives">Archives</el-menu-item>
          <el-menu-item index="/log">Blogs</el-menu-item>
          <el-menu-item index="/messageBoard">Messages</el-menu-item>

          <el-col :span="4" :offset="4">
            <el-menu-item index="/write"><i class="el-icon-edit"></i>New Article</el-menu-item>
          </el-col>
