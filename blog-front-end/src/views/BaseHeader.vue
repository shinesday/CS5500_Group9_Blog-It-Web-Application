    ...
    <el-row class="me-header">
      ...
      <el-col v-if="!simple" :span="12">
        <el-menu :router=true menu-trigger="click" active-text-color="#5FB878" :default-active="activeIndex"
          ...
          <el-menu-item index="/tag/all">Tag</el-menu-item>
          <el-menu-item index="/archives">Archive</el-menu-item>

          <el-col :span="4" :offset="4">
            <el-menu-item index="/write"><i class="el-icon-edit"></i>new articles</el-menu-item>
          </el-col>
